...
{
	TextureManager::Instance()->load("../Assets/textures/Shawty.png","shawty");

	auto size = TextureManager::Instance()->getTextureSize("shawty");
	setWidth(size.x);
	setHeight(size.y);
...
void Ship::draw()
{
	...
	// draw the ship
	TextureManager::Instance()->draw("shawty", x, y, m_currentHeading, 255, true);
}
...
void Ship::m_changeDirection()
{
	...
	glm::vec2 size = TextureManager::Instance()->getTextureSize("shawty");
}
